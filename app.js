// MadeGood Budget Tracker                                                                                                                                                                                
  ...
  function bindAll() {
    ...
    document.getElementById('convert-confirm').addEventListener('click', async () => {
      ...
      btn.disabled = true; btn.textContent = 'Saving…';                                                                                                                                                     
      await update(convertId, { entry_type: 'actual', amount });                                                                                                                                            
  ...
  function quickConvert(id) {                                                                                                                                                                               
    ...
    document.getElementById('convert-amount').value = entry.amount;                                                                                                                                         
    document.getElementById('convert-overlay').classList.remove('hidden');
    document.getElementById('convert-amount').focus();
    document.getElementById('convert-amount').select();                                                                                                                                                     
  }
  function closeModal() {                                                                                                                                                                                   
    editId = null;                                          
